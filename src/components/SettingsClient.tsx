...
function SettingRow({ icon, title, description, children, last = false, isLight }: { icon: string; title: string; description?: string; children: React.ReactNode; last?: boolean; isLight: boolean }) {
  return (
    <div style={{
      display: "flex",
